    ...
    return (
        <>
            ...
            <Container className="my-5">
                ...
                <Row>
                    <Col className="my-5">
                        <Button className="me-4" style={{ backgroundColor: '#ff8c7a', color: 'black', border: '#ff8c7a' }}>
                            취소
                        </Button>
                        <Button className="me-4" style={{ backgroundColor: '#ff8c7a', color: 'black', border: '#ff8c7a' }} onClick={handleSubmit}>
                            작성
                        </Button>
                    </Col>
                </Row>
